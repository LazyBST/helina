...
export declare class AwsS3Service {
    ...
    getPresignedUrl(config: S3ClientConfig, commandConfig: GetObjectCommandInput | PutObjectCommandInput, permission: PresignedUrlPermission, expiry: number): Promise<IPresignedUrlResponse>;
